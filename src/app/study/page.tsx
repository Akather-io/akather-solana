      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 md:gap-6 lg:gap-8 py-14">
        <div className="bg-[#F4F5FF] rounded-[20px] p-4 space-y-4 flex flex-col w-full relative">
          ...
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center space-x-3">
              <div className="w-[50px] h-[50px] aspect-square min-w-0 rounded-[10px]">
                <Image
                  src={`https://picsum.photos/50/50?random=1455`}
                  width={50}
                  height={50}
                  alt=""
                  quality={100}
              ...
              <div className="flex flex-col">
                ...
                <span className="text-black">
                  {"D6ghYKKSngtijiDtyEjR1Q4PwQmeh24u5mgMFkvw4dq".slice(0, 10) +
                    "...."}
                </span>
              </div>
            </div>
          ...
          <div className="flex space-x-[10px]">
            <button
              onClick={handleBuy}
              className="w-[calc(50%-5px)] btn border-0 outline-none flex items-center justify-center gap-2 rounded-full text-white bg-[linear-gradient(90deg,#4588C7_3.67%,#354387_96.33%)]"
            >
              <IconSvgShop />
              Buy Now
            </button>
